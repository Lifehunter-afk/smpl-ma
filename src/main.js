...
const I18N = {
    en: {
            ...
            items: [
                {
                    ...
                    a: `
            <p>ENIGMA analyzes market data and keeps only setups that pass risk and entry-quality filters.</p>
          `,
                },
                {
        ...
        analyzer: {
            ...
            idleLine1:
                "Select pair, expiry and AI model to see how ENIGMA core reacts.",
            idleLine2:
            ...
            items: [
                {
                    ...
                    a: `
            <p>ENIGMA анализирует рынок и оставляет только те сетапы, которые прошли фильтры по риску и качеству входа.</p>
          `,
                },
                {
